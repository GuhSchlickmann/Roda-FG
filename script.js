...
const CONFIG = {
    ...
    backendUrl: 'https://script.google.com/macros/s/AKfycbzdlxm1quNDcqSm6hri4ll2vtdUIScCvqvqq7qdjeiLL8Ridbz7bz91Zz8PMscNi0TLHg/exec',
...
function initSplitListeners() {
    ...
    if (btnPositive && header && bizNameText) {
        btnPositive.addEventListener('mouseenter', () => {
            ...
            bizNameText.style.opacity = '0';
            setTimeout(() => {
                bizNameText.textContent = "Clique sobre o ícone, e nos conte como está sendo sua experiência, na RodaFG!";
                bizNameText.style.opacity = '1';
            }, 300);
        });
        ...
        btnPositive.addEventListener('click', async () => {
            ...
            const redirectToGoogle = () => {
                ...
                if (selectedRating) {
                    try {
                        finalURL = finalURL.replace(',3,,,,', `,3,,,${selectedRating},`);
                    } catch (e) {
